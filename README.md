...
This library gives easy control over the 16 pins of a TCA9554 chip.
...
_The TCA9535 is identical to the TCA9554, except that the TCA9535 does not include the internal I/O
...
There is a TCA9535 class which is a (convenience) wrapper around the TCA9554 class. 
...
The addresses for the TCA9554 and TCA9535 are 0x20..0x27.
These are to be set with pin A0, A1, A2.

Both the TCA9554 and TCA9535 support up to 400 kHz I2C.
